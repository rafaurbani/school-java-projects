...
public class DLinkedList<E> implements List<E> {
	...
	protected NodeClass<E> head;
	protected NodeClass<E> tail;
	protected int size;
	...
	public void addEnd(E element) throws IndexOutOfBoundsException, OverflowException {
		insert(element, size);
	}
	...
	public void removeNodes(int pos, int quantosNodes) {
		...
		NodeClass<E> nextFromRemoved = current;
	...
	public void insereLista(DLinkedList<E> outraLista, int pos) throws OverflowException {
		...
		NodeClass<E> nextFromList = current.getNext();
